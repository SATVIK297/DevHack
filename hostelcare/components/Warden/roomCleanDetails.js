...
//           ) : (
//             employeeHistory.slice(0, 3).map((request) => ( // Show only the first 3 history entries
...
//         {employees.slice(0, 5).map((employee) => ( // Show only the first 5 employees
